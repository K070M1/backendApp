...
public class District {
	...
	public District(String _id, String name, String cod, String ubigeo, String inei, @NotNull StateType stateType_id,
			@NotNull Country country_id, @NotNull Departament departament_id, @NotNull Province province_id,
	...
	public String toString() {
		return "District [_id=" + _id + ", name=" + name + ", cod=" + cod + ", ubigeo=" + ubigeo + ", inei=" + inei
				+ ", stateType_id=" + stateType_id + ", country_id=" + country_id + ", departament_id=" + departament_id
				+ ", province_id=" + province_id + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + "]";
	}
